...
use [our template on GitHub](https://github.com/gamepark/board-mythic-arena)
...
- `Mythic Arena` => `Name of your Game`
...
Once you have one Material type and one Location type, you can start to setup a new game in [MythicArenaRules.ts](/rules/src/MythicArenaRules.ts)
